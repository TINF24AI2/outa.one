            ...
            <Field.Set class="gap-6">
                ...
                <Field.Group class="gap-5">
                    ...
                    <Field.Field class="gap-2">
                        ...
                        <div
                            class="border-input focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-3 flex h-10 overflow-hidden rounded-md border shadow-xs"
                        >
                            <input
                                id="maxlicenses"
                    ...
                    <Field.Field class="flex-row align-center gap-2">
                        <div class="flex-col">
                            <Label for="reqapproval" class="pb-1"
                                >{m.products_popup_add_requires_approval_label()}</Label
                            >
